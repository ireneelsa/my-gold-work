...
const features = [
  ...
  ['14.jpg', 'Hand holding a phone showing a gold necklace product page while a finger taps the Share button, in a busy jewellery shop with staff at the counter', 'share', 'Share with your shop name', 'Send a jewellery link on WhatsApp. Customers try it from home.'],
