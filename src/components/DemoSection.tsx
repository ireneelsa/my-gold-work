...
export default function DemoSection() {
  ...
  return <section className="demo" id="demo" aria-labelledby="demo-title"><div className="in">
    <div className="txt reveal" ref={textRef}><p className="label">Get a demo</p><h2 id="demo-title">Your craftsmanship. <em className="gi" style={{ display: 'block' }}>A new way to show it.</em></h2><p className="lead">See what LIVE TRY-ON can do for your jewellery business.</p><div className="cta"><a className="btn btn-gold" href="https://play.google.com/store/apps/details?id=com.techiearray.delivery" target="_blank" rel="noopener"><Icon name="download" />Download the app</a><a className="btn btn-line" href={WHATSAPP_DEMO_URL} target="_blank" rel="noopener"><Icon name="chat" />Request a demo</a></div><div className="reach"><a className="tel" href="tel:+919160591699"><Icon name="phone" />+91 91605 91699</a><a className="talk" href={WHATSAPP_DEMO_URL} target="_blank" rel="noopener"><Icon name="chat" />Let’s talk</a></div></div>
